...
<div class="pb-20">
	<a href="/" class="inline-flex min-h-12 items-center text-sm text-primary">&larr; Quay lai</a>
		...
		{:else if showBookingForm}
			<div class="mt-4 rounded-xl bg-card p-4">
				...
				<div class="mt-3 space-y-3">
					<input bind:value={bookingName} placeholder="Ho ten" autocomplete="name" class="min-h-12 w-full rounded-lg border border-border bg-background px-4 text-sm" />
					<input bind:value={bookingPhone} placeholder="So dien thoai" type="tel" inputmode="tel" autocomplete="tel" class="min-h-12 w-full rounded-lg border border-border bg-background px-4 text-sm" />
					...
					<input bind:value={bookingNotes} placeholder="Ghi chu (tuy chon)" class="min-h-12 w-full rounded-lg border border-border bg-background px-4 text-sm" />
