...
function getToken(): string | null {
	return typeof localStorage !== 'undefined' ? localStorage.getItem('driver_token') : null;
}

function getRefreshToken(): string | null {
	return typeof localStorage !== 'undefined' ? localStorage.getItem('driver_refresh_token') : null;
}

export function setTokens(access: string, refresh: string) {
	if (typeof localStorage !== 'undefined') {
		localStorage.setItem('driver_token', access);
		localStorage.setItem('driver_refresh_token', refresh);
	}
}
